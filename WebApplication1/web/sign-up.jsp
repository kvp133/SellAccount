<%-- 
    Document   : Sign-up
    Created on : Jan 22, 2024, 1:15:34 PM
...
<html lang="en">
    <head>
        ...
        <title>Sign up | Chill Store</title>
        ...
        <main class="auth">
            ...
            <div class="auth__intro">
                <a href="./" class="logo auth__intro-logo d-none d-md-flex">
                    ...
                    <h1 class="logo__title">Chill Store</h1>
                </a>
            ...
            <div id="auth-content" class="auth__content hide">
                <div class="auth__content-inner">
                    <a href="./" class="logo">
                        <img src="./assets/icons/logo.svg" alt="chillstore" class="logo__img" />
                        <h1 class="logo__title">Chill Store</h1>
                    </a>
...
<%--                    </c:if>--%>
                    ...
                    <form action="register" class="form auth__form" method="post">
                        <div class="form__group">
                            <div class="form__text-input">
                                ...
                                />
                                <img src="./assets/icons/nameregister.svg" alt="" class="form__input-icon" />
                                <img src="./assets/icons/form-error.svg" alt="" class="form__input-icon-error" />
                            </div>
                            <p class="form__error">Write error some thing</p>
                        </div>
                        <div class="form__group">
                            <div class="form__text-input">
                                <input
                        ...
                        <div class="form__group">
                            ...
                            <p class="form__error">Error Something</p>
                        </div>
                        <div class="form__group">
                            <div class="form__text-input">
                                <input
                        ...
                        <div class="form__group form__group--inline">
                            <label class="form__checkbox">
                                ...
                                <span class="form__checkbox-label">Confirm my police</span>
                            </label>
                        </div>
                           <div class="form__group form__group--inline">
                    ...
                    <p class="auth__text">
                        ...
                        <a href="./login" class="auth__link auth__text-link">Sign In</a>
                    </p>
                </div>
            </div>
        </main>
