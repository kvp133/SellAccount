...
const isDark = localStorage.dark === "true";
document.querySelector("html").classList.toggle("dark", isDark);
// Get a collection of elements with class 'unsubmitBtn'
document.addEventListener('DOMContentLoaded', function() {
            // Get a NodeList of elements with class 'unsubmitBtn'
            var unsubmitBtns = document.querySelectorAll('.unsubmitBtn');
            var inputSearchs = document.getElementById('textSearchHere');
            // Iterate through each element and add an event listener
            unsubmitBtns.forEach(function(btn) {
                btn.addEventListener('click', function(event) {
                    // Ngăn chặn sự kiện submit mặc định
                    event.preventDefault();
                    // Xử lý khác nếu cần
                    inputSearchs.value = btn.innerText;
