<%-- 
    Document   : login
    Created on : Jan 29, 2024, 4:32:46 PM
...
<head>
  ...
  <title>ChillStoreAdmin - Login</title>
                  ...
                  <form class="user" action="loginadmin" method="post">
                    <div class="form-group">
                      <input type="text" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp"
                        placeholder="Enter Email Address" name="txtAdminUserName">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control" id="exampleInputPassword" placeholder="Password" name="textAdminPassword">
                    </div>
                    <div class="form-group">
