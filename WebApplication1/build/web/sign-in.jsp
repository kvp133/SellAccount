<%-- 
    Document   : sign-in
    Created on : Jan 22, 2024, 1:15:09 PM
...
<html lang="en">
    <head>
        ...
        <title>Sign in | Chill Store</title>
            ...
            <div class="auth__content">
                <div class="auth__content-inner">
                    <a href="./" class="logo">
                        ...
                        <h2 class="logo__title">Chill Store</h2>
                    </a>
                    ...
                    <p class="auth__text">
                        ...
                        <a href="login" class="auth__link auth__text-link">Sign Up</a>
                    </p>
                </div>
            </div>
        </main>
