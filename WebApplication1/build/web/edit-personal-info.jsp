                    ...
                    <div class="cart-info">
                        <div class="row gy-3">
                            <div class="col-12">
                                ...
                                <form action="editpersonalinfo" class="form form-card" method="post">
                                    <!-- Form row 1 -->
                                    <div class="form__row">
                                        <div class="form__group">
                                            ...
                                            <p class="form__error">Please enter your firstn name</p>
                                        </div>
                                        <div class="form__group">
                                            <label for="full-name" class="form__label form-card__label">
                                                Last Name
                                    ...
                                    <div class="form-card__bottom">
                                        ...
                                        <input value="Save" type="submit" class="btn btn--primary btn--rounded">
                                    </div>
                                </form>
                            </div>
                        </div>
